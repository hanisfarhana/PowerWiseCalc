package com.androidproject.powerwisecalc;
...
import com.androidproject.powerwisecalc.databinding.ActivityAboutBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.linkToGitHubTv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String githubUrl = "https://github.com/hanisfarhana/PowerWiseCalc";
